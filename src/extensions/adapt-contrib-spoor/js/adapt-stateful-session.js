define([
  ...
  var AdaptStatefulSession = _.extend({
    ...
    restoreSessionState: function(callback) {
      ...
      if (sessionPairs.r) {
        reflectionState = sessionPairs.r; // SCORMSuspendData.deserialize(optionalState.r);
      }
    ...
    getSessionState: function() {
      ...
      var sessionPairs = Adapt.offlineStorage.get();
      var reflectionData = sessionPairs.r;
      
      Adapt.log.info(`course._isComplete: ${courseComplete}, course._isAssessmentPassed: ${assessmentPassed}, BlockCompletion: ${blockCompletion}, ReflectionData: ${reflectionData}`);
