define ([
  ...
  */
  ...
  ScormWrapper.prototype.setLeadershipValue = function(_value) {
    this.setValue(this.isSCORM2004() ? "cmi.leadership_value" : "cmi.core.leadership_value", _value);
  };

  // ScormWrapper.prototype.setReflectionData = function(_data) {
  //   this.setValue(this.isSCORM2004() ? "cmi.reflection_data" : "cmi.core.reflection_data", _data);
  // };

  // ScormWrapper.prototype.getReflectionData = function() {
  //   return this.getValue(this.isSCORM2004() ? "cmi.reflection_data" : "cmi.core.reflection_data");
  // };
