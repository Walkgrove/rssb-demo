define([
  ...
  var helpers = {
    ...
    import_globals: function(context) {
      context.data.root._dev = Adapt.course.get('_dev');
      context.data.root._frameworkVersion = Adapt.course.get('_frameworkVersion');
      context.data.root._courseVersion = Adapt.course.get('_courseVersion');
    ...
    import_buttons: function(context) {
      if (context.data.root._buttons) {
        return '';
      }
      context.data.root._buttons = Adapt.course.get('_buttons');
      return '';
    },
