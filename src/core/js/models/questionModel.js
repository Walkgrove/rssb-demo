  ...
  class QuestionModel extends ComponentModel {
    ...
    setupCorrectFeedback() {
      ...
      if (Adapt.config.get('_sound')._isActive === true) {
        if (this.get('_feedback')._audio) {
          Adapt.trigger('audio:partial', {src: this.get('_feedback')._audio._src, transcript: this.get('_feedback')._audio.transcript});
        }
      }
    }
    ...
    setAttemptSpecificFeedback(feedback) {
      ...
      //audio?
      if (Adapt.config.get('_sound')._isActive === true) {
        if (this.get('_feedback')._incorrect._audio) {
          Adapt.trigger('audio:partial', {src: this.get('_feedback')._incorrect._audio._src, transcript: this.get('_feedback')._incorrect._audio.transcript});
        }
      }
    }
